...
namespace Perpetuum.Modules.Weapons
{
    ...
    public sealed class DamageInfo
    {
        ...
        public IList<Damage> plantDamages = [];
        ...
        public IList<Damage> CalculateDamages(Unit target)
        {
            ...
            if (zone != null && damages != null)
            {
                ...
                double damageModifier = IsCritical ? CRITICALHIT_MOD : 1.0;
                ...
                {
                    double distance = sourcePosition.TotalDistance2D(target.CurrentPosition);
                    double range = Range;
                    ...
                    {
                        double x = (distance - _optimalRange) / _falloff;
                ...
                if (damageModifier > 0.0)
                {
                    ...
                    {
                        double tmpDamageMod = target.SignatureRadius / _explosionRadius;

                        if (tmpDamageMod is <= 0.0 or >= 1.0)
                        {
                            tmpDamageMod = 1.0;
                        }
        ...
        public static IDamageBuilder Builder => new DamageBuilder();
        ...
        private class DamageBuilder : IDamageBuilder
        {
            ...
            private readonly IList<Damage> _plantDamages = [];
            private double _optimalRange;
            private double _falloff;
            private double _explosionRadius;
