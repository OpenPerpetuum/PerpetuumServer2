...
namespace Perpetuum.RequestHandlers.Corporations
{
    public class CorporationCharacterInvite : IRequestHandler
    {
        ...
        {
            Character issuerCharacter = request.Session.Character;
            Character newMember = Character.Get(request.Data.GetOrDefault<int>(k.memberID));
            ...
            Corporation corporation = issuerCharacter.GetCorporation();
            ...
            DefaultCorporation targetCharactersCorporation = newMember.GetCorporation().ThrowIfNotType<DefaultCorporation>(ErrorCodes.CharacterMustBeInDefaultCorporation);
