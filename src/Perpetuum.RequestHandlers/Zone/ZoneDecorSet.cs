...
namespace Perpetuum.RequestHandlers.Zone
{
    public class ZoneDecorSet : IRequestHandler<IZoneRequest>
    {
        public void HandleRequest(IZoneRequest request)
        {
            ...
            DecorDescription decorDescription = new()
            {
            ...
            request.Zone.DecorHandler.Decors.TryGetValue(decorDescription.id, out DecorDescription oldDescription).ThrowIfFalse(ErrorCodes.ItemNotFound);
