...
namespace Perpetuum.Services.MissionEngine.MissionTargets
{
    ...
    public class MissionTargetInProgress
    {
        ...
        public MissionTargetType TargetType => myTarget.Type;

        public int MissionTargetId => myTarget.id;

        public int TargetOrder => myTarget.targetOrder;

        public int DisplayOrder => myTarget.displayOrder;

        public bool IsMyTurn => TargetOrder == myMissionInProgress.currentTargetOrder;
        ...
        public void GetSuccessInfo(IDictionary<string, object> info)
        {
            ...
            {
                int locationId = info.GetValue<int>(k.locationID);
        ...
        {
            List<Character> affectedCharacters = myMissionInProgress.GetAffectedCharacters();
        ...
        public bool IsTargetBranching => myTarget.IsBranching;

        public DateTime SuccessTime => _successTime ?? DateTime.Now;

        public Position SuccessPosition => new(_successX ?? 0, _successY ?? 0);


        public bool ValidSuccessInfoSet => _successTime != null && _successX != null && _successY != null && _successZoneId != null;
        ...
        {
            DbQuery dbQuery = Db.Query().CommandText("mission_writetargetinprogress")
            ...
            int res = dbQuery.ExecuteScalar<int>();
        ...
        {
            LockUnitRandomTarget? lockUnitTarget = myTarget as LockUnitRandomTarget;
        ...
        {
            DeliveryHelper helper = _deliveryHelperFactory();
        ...
        {
            MissionTargetRewardCalculator trc = new(myMissionInProgress, this, estimation);
        ...
        {
            int res = Db.Query().CommandText("INSERT dbo.missiontargetslog ( zoneid, x, y, targettype, guid, locationeid, missioncategory ) VALUES ( @zoneId, @x, @y, @targetType, @guid, @locationeid, @category )")
                .SetParameter("@x", x)
                .SetParameter("@y", y)
    ...
    public class SuccessLogInfo
    {
        ...
        public void AddToInsertList(List<string> insertList)
        {
            ...
            string oneLine = string.Format("INSERT dbo.missiontargetslog ( zoneid, x, y, targettype, guid, locationeid, missioncategory {7} ) VALUES ( {0}, {1}, {2},{3}, '{4}', {5},{6} {8} )", zoneId, x, y, (int)targetType, guid.ToString(), locationEid, (int)missionCategory, (eventTime == null) ? "" : ",eventtime", (eventTime == null) ? "" : ",'" + ((DateTime)eventTime).ToString("O")[..19] + "'");
