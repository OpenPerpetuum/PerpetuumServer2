...
namespace Perpetuum.Network
{
    public class TcpConnection : Disposable, ITcpConnection
    {
        ...
        private void ReceiveCallback(IAsyncResult ar)
        {
            ...
            try
            {
                int available = _socket.EndReceive(ar);
                ...
                while (index < available)
                {
                    ...
                    byte[] packetData = _packetStream.ToArray();
        ...
        private readonly Queue<byte[]> _outBuffer = new();
        private bool _sending;
        private SpinLock _sendLock = new();
